...
if __name__ == "__main__":
    ...
    images, rpn_cls_gt, rpn_reg_gt, original_shapes = utils.data_generator(config)

    # TRAINING
    print("TRAINING ...")
    train_wrapper.fit_model(inputs=[images, rpn_cls_gt, rpn_reg_gt])
    # SAVE MODEL
    ...
    test_gt = rpn_reg_gt[0:num_test_images]
    utils.write_solutions(test_input, test_output, test_shapes, test_gt, verbose=True)
